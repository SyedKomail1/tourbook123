...
<View style={{ flex: 1, flexDirection: "row", marginLeft:288,    elevation: 5
 }}>

<MaterialCommunityIcons name="map-marker-multiple"  color={COLORS.white} size={28}
onPress={() => navigation.navigate("Userprofile2")} />
        ...
        <View style={{ flex: 1, flexDirection: "row", marginLeft:10,marginBottom:-40, marginRight:10,}}>
        ...
        <View style={{ flex: 1, flexDirection: "row", marginLeft:10,marginBottom:-10, marginRight:10,}}>
          <View style={{ flex: 1, margin:10, }}>
          <Button1
